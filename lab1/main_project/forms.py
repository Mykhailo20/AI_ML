...
class QuizForm(FlaskForm):
    novice_q1_choice = SelectField(u"Переживаєте за успіх в роботі?", 
                                   choices=[(5, "сильно"), (3, "не дуже"), (2, "спокійний")])
    novice_q2_choice = SelectField(u"Прагнете досягти швидко результату?", 
                                   choices=[(5, "дуже"), (3, "якомога швидше"), (2, "поступово")])
    novice_q3_choice = SelectField(u"Легко попадаєте в тупик при проблемах в роботі?", 
                                   choices=[(5, "неодмінно"), (3, "поступово"), (2, "зрідка")])
    novice_q4_choice = SelectField(u"Чи потрібен чіткий алгоритм для вирішення задач?", 
                                   choices=[(5, "так"), (3, "в окремих випадках"), (2, "не потрібен")])
    
    adv_beg_q1_choice = SelectField(u"Чи використовуєте власний досвід при вирішенні задач?", 
                                    choices=[(5, "зрідка"), (3, "частково"), (2, "ні")])
    adv_beg_q2_choice = SelectField(u"Чи користуєтесь фіксованими правилами  для вирішення задач?", 
                                    choices=[(5, "не потрібні"), (3, "в окремих випадках"), (2, "так")])
    adv_beg_q3_choice = SelectField(u"Чи відчуваєте ви загальний контекст вирішення задачі?", 
                                    choices=[(5, "в окремих випадках"), (3, "частково"), (2, "так")])

    comp_q1_choice = SelectField(u"Чи використовуєте власний досвід при вирішенні задач?", 
                            choices=[(5, "зрідка"), (3, "частково"), (2, "ні")])
    comp_q2_choice = SelectField(u"Чи користуєтесь фіксованими правилами  для вирішення задач?", 
                            choices=[(5, "не потрібні"), (3, "в окремих випадках"), (2, "так")])
    comp_q3_choice = SelectField(u"Чи відчуваєте ви загальний контекст вирішення задачі?", 
                            choices=[(5, "в окремих випадках"), (3, "частково"), (2, "так")])
    
    prof_q1_choice = SelectField(u"Чи необхідний вам весь контекст задачі?", 
                            choices=[(5, "так"), (3, "в окремих деталях"), (2, "в загальному")])
    prof_q2_choice = SelectField(u"Чи переглядаєте ви свої наміри до вирішення задачі?", 
                            choices=[(5, "так"), (3, "зрідка"), (2, "коли є потреба")])
    prof_q3_choice = SelectField(u"Чи здатні  ви  навчатись у інших?", 
                            choices=[(5, "так"), (3, "зрідка"), (2, "коли є потреба")])
    
    exp_q1_choice = SelectField(u"Чи обираєте ви нові методи своєї роботи?", 
                            choices=[(5, "так"), (3, "вибірково"), (2, "вистачає досвіду")])
    exp_q2_choice = SelectField(u"Чи допомагає власна інтуїція при вирішенні задач?", 
                            choices=[(5, "так"), (3, "частково"), (2, "при емоційному напруженні")])
    exp_q3_choice = SelectField(u"Чи застовуєте рішення задач за аналогією?", 
